...
const services = [
  ...
  },
  {
    ...
    icon: "B",
    color: "#9a6b2f",
    basis: "공영차고지 거리와 생활서비스 이동 기반을 본 대리 지표",
    policy: "정류장 좌표와 보행 동선 데이터로 후속 검증합니다.",
  },
  {
    key: "care_score",
    point: "care",
...
> = {
  ...
  "이동 접근 보완형": {
    summary: "교통 기반시설과 보행 연결을 함께 볼 생활권",
    why: "교통 거점이 있어도 보행동선·경사·횡단 여건이 불편하면 체감 접근성은 낮아집니다.",
    signal: "공영차고지 기준 교통 대리 점수가 낮고 생활서비스 이동 의존도가 높습니다.",
    now: "정류장 좌표, 보행동선, 경사, 횡단 안전을 추가 점검합니다.",
